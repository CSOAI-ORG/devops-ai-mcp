<!-- mcp-name: CSOAI-ORG/devops-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/devops-ai-mcp.html)
...
[![PyPI](https://img.shields.io/badge/PyPI-Install-3775a9)](https://pypi.org/project/devops_ai_mcp/)
...
- [Full Documentation](https://docs.meok.ai/devops-ai-mcp)
...
- "Use `docker_compose_generator` to …"
- "Use `cicd_pipeline_builder` to …"
- "Use `log_analyzer` to …"
